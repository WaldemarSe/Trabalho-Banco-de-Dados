            ...
            <div className="w-full bg-white p-3 rounded border border-gray-200 relative pb-12">
              ...
              {ehDonoOuColaborador && (
                <Link
                  ...
                  className="absolute bottom-2.5 right-2.5 flex items-center gap-1 text-[11px] font-bold text-[#0969da] bg-slate-50 hover:bg-slate-100 border border-[#d0d7de] px-2.5 py-1.5 rounded-md shadow-3xs transition-all cursor-pointer hover:border-gray-400"
                >
                  <svg className="w-3.5 h-3.5 text-[#00a2ed]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
